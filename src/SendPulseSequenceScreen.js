...
export default class SendPulseSequence extends Component {
  ...
  updateStringToArrayState = (key, value) => {
    this.setState({
      [key]: value
        .split(",")
        .map(i => i.trim())
        .filter(i => i && Number.isInteger(Number(i)))
    });
  };
  ...
  handleSend = () => {
    ...
    let nPstd = new Array();
    nFpsi.push(
      parseInt(this.state.firstPulseSpaceLeft),
      parseInt(this.state.firstPulseSpaceRight)
    );
    nAmp_pp.push(
        ...
        <ScrollView style={styles.scrollViewStyle}>
          <View style={styles.inputRowContainer}>
            <InputField
              ...
              onChangeText={value => {
                this.updateState("firstPulseSpaceLeft", value);
              }}
            ...
            <InputField
              ...
              onChangeText={value => {
                this.updateState("firstPulseSpaceRight", value);
              }}
              keyboardType="numeric"
              inRow
            />
