...
export default class SendSquareWaveScreen extends Component {
  ...
  handleSend = () => {
    ...
    fhchll.push(parseInt(this.state.firstHalfCycleHiLoLeft), parseInt(this.state.firstHalfCycleHiLoRight));
    amp.push(parseInt(this.state.peaKToPeakAmplitudeLeft), parseInt(this.state.peaKToPeakAmplitudeRight));
    RNWaveformAudioLib.SendSquareWave(freq, fhchll, amp, parseInt(this.state.length));
  }
      ...
      <ScrollView style={styles.scrollViewStyle} horizontal={true}>
        <View style={styles.inputRowContainer}>
          <InputField
            title="Freq Left"
            value={freqLeft}
            onChangeText={(value) => { this.updateState('freqLeft', value); }}
          ...
          <InputField
            title="Freq Right"
            value={freqRight}
            onChangeText={(value) => { this.updateState('freqRight', value); }}
            keyboardType="numeric"
            inRow
          />
        </View>
        ...
        <View style={styles.inputRowContainer}>
          <InputField
            ...
            onChangeText={(value) => { this.updateState('firstHalfCycleHiLoLeft', value); }}
            keyboardType="numeric"
            inRow
          />
          <InputField
            ...
            onChangeText={(value) => { this.updateState('firstHalfCycleHiLoRight', value); }}
            keyboardType="numeric"
            inRow
          />
        </View>
        ...
        <InputField
          title="Length"
          value={length}
          onChangeText={(value) => { this.updateState('length', value); }}
          keyboardType="numeric"
        />
